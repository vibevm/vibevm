...
- [ ] **B-080** — тест/пример слепого выбора + починка (слово
      владельца): воркер claudez, `.wt/P2-MIRROR`, PACKET-B080.
- [ ] **TUI до конца** (директива владельца): PROP-037-остаток B-077
      закрыт и зафлипан в спеке; осушение dead_code-тени — замер-карта
      воркером codex (`.wt/P2-CODEGEN`, PACKET-TUI-DRAIN-MAP), затем
      строительные пакеты по карте.
- [ ] **B-095** — рекомендация босса дана в чате, ждёт слова владельца.
