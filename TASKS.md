...
- [ ] **§5a Замер динамических роутеров во внешних агентах** («самое
      сложное» — владелец): probe-протокол на полигоне через две доступные
      независимые worker lanes по текущим routing rules, контрольные вопросы
      внутри динамических XML-целей +
