...
## Партия P3-мелочи (/goal 2026-08-20, вечер-2)

- [ ] **B-088** — гейт закрытых планов: воркер codex (P2-CODEGEN;
      реестр CLOSED-PLANS.toml + шаг панели); босс: обе живые ссылки
      уже пере-словлены в жанр-3 (двое из «четырёх» умерли эволюцией).
- [ ] **AUDIT -11(a)** — `slot_integrity=verify` спот-чек вместо
      пере-копии: воркер claudez (P2-MIRROR, PACKET-P011V).
- [ ] **AUDIT 08-06-01 (P1-половина)** — индивидуальный пере-суд 84
      якорей PROP-008 на общем blob'е: воркер claudez (P2-PREFS,
      PACKET-B08601); merge/seal — босс.
