/**
 * vibeframe — pure argument + command helpers.
 *
...
/**
 * Parse vibeframe's command-line flags out of an argv array.
 *
 ...
 * caller, which passes its choice through `--exec`; vibeframe's own default is
