...
| `scaffold-d-differential-oracle` | E | scaffold D | gate | [E-mid] | shipped: oracle-presence (`cell-has-oracle`, rust-ai-native-conform); the oracle itself stays authored |
| `scaffold-e-fast-loop` | E+H | scaffold E | gate | [E-strong] | shipped (`rust-ai-native fast-loop`) |
| `scaffold-f-structured-diagnostics` | E+C | scaffold F | inline | [E-mid] | shipped (`error-enum/message-cites-req`, rust-ai-native-conform) |
| `scaffold-g-doctests` | C+G | scaffold G | gate | [E-strong] | shipped (`seam-has-doctest` + `pub-doctest`, rust-ai-native-conform) |
