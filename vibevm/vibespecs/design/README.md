...
| @fact:ROW-DOCS `vibevm/vibepacks/org.vibevm.core/vibevm-docs/` — the documentation package, opened by the `docs-2026-09` campaign (row added 2026-09-11) @status:spec/plan |  @fact:ROW-DOCS-HOLDS **Documentation** — what a consumer needs in order to *use* the product: explanations, scenarios, references, a glossary. Non-normative; cites the contracts one way and never restates a normative value; observed by the facts corpus but never judged — [PROP-057 §14](../common/PROP-057-documentation-packages-and-site.xml) @status:spec/plan |  @fact:ROW-DOCS-NORMATIVE no @status:spec/plan |
...
- @fact:idx-documentation-maintenance [The documentation maintenance regulation](documentation-maintenance.xml) — the maintenance regulation of the documentation packages, drafted 2026-09-10 and rehearsed in phase 6 of the documentation campaign; PROP-058 is the norm, this is its reasoning @status:spec/done
