...
| One module's contract or invariant | `vibevm/vibespecs/modules/<m>/PROP-*` |
| A feature's scope and acceptance criteria | `vibevm/vibespecs/modules/<m>/FEAT-*` |
...
- the directory name under `vibevm/vibespecs/modules/` is the `<module>` segment;
