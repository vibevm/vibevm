//! `rust-ai-native-tcg bench` — the differential/latency harness (D10): every
...
specmark::scope!("spec://rust-ai-native-lang/mechanisms/TCG-ORACLE-RUST-v0.1#approximation");
...
///
/// ```
/// assert_eq!(rust_ai_native_tcg::bench::map_code("E0107"), "E0061");
/// assert_eq!(rust_ai_native_tcg::bench::map_code("E0308"), "E0308");
/// assert_eq!(rust_ai_native_tcg::bench::map_code("weird"), "weird");
/// ```
