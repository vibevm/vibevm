...
- [`spec/flows/delegation-rules/DECISION-MATRIX.xml`](spec/flows/delegation-rules/DECISION-MATRIX.xml)
...
- [`spec/boot/77-flow-delegation-rules.xml`](spec/boot/77-flow-delegation-rules.xml)
  — the boot snippet a consuming boss loads at session start.

Authored clean-room from the study note
`fractality/v0.1.0/spec/refs/notes/codex-first-study.xml` (decisions
