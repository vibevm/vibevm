...
/// assert_eq!(cfg.spec_roots, vec!["vibevm/vibespecs".to_string()]);
...
impl Default for Config {
    fn default() -> Self {
        Config {
            ...
            // PROP-052: every project keeps authored specs under the distinctive
            // `vibevm/vibespecs` root; logical `spec://` addresses stay stable.
            spec_roots: vec!["vibevm/vibespecs".into()],
