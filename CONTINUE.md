...
обязательства / 210 дрейфов — 24 отложено решениями владельца, 78 открыто;
owed 54, ВСЕ на sync-маршруте владельца**. Boss-owed — ноль по всем маршрутам.
Ситтинг 2026-08-02 (после session-end): предъявления F-185 / семья дупликаций /
остаток F-132 отсужены «стройками вместо смягчения» — B-033/B-034/B-035
зафайлены, B-029 обогащён, B-011 поднят до Самого Высокого Приоритета,
...
1. **Хвосты ситтинга 2026-08-02 (предъявления ruled и исполнены — F-185 /
   F-218 / F-132 отложены на записанные стройки, ledger
   `#rulings-2026-08-02-2`):** на владельце остаются **второй якорь F-217**
   (тройка CLAUDE/AGENTS/GEMINI — рука-копия без сверки: шаг-проверка в
   план или записанное исключение?), **F-285 «снять обвинение?»**
   (правило про временнóе переиспользование адреса судили за одновременную
   компиляторную коллизию; временного переиспользования не нашлось), и
   далее — **остатки sync-очереди по registry**. Формат предъявлений,
   обязательный вперёд (уточнение 2026-08-02 поверх формата (ii)): сначала
