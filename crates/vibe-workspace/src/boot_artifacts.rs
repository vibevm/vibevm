...
/// Generated INDEX filename, relative to a node's `spec/boot/`.
...
const STATIC_XML_HEADER: &str = "\
<!-- spec/boot/STATIC.xml — generated by vibe, do not edit. -->
<!-- The static boot lane (PROP-009 §2.3): the highest-priority -->
<!-- contributions, compiled anchor-qualified. Read this first, in full. -->
...
pub fn render_static_with_spec_format(
    ...
    let mut out = String::from(match spec_format {
        SpecFormat::Xml => STATIC_XML_HEADER,
        SpecFormat::Mixed | SpecFormat::Markdown => STATIC_HEADER,
    });
