...
const RESOLUTION_PREAMBLE_PREFIX: &str = "\
...
const RESOLUTION_PREAMBLE_SUFFIX: &str = "/,
...
fn resolution_preamble() -> String {
    format!(
        "{RESOLUTION_PREAMBLE_PREFIX}{}{RESOLUTION_PREAMBLE_SUFFIX}",
        layout_paths::vibedeps("")
    )
}

const STATIC_HEADER_SUFFIX: &str = " — generated by vibe, do not edit. -->
<!-- The static boot lane (PROP-009 §2.3): the highest-priority -->
<!-- contributions, compiled anchor-qualified. Read this first, in full. -->

";

fn static_header(spec_format: SpecFormat) -> String {
    format!("<!-- {}{STATIC_HEADER_SUFFIX}", static_path(spec_format))
}
...
pub fn render_static_with_spec_format(
    ...
    let mut out = static_header(spec_format);
