...
// `*.jtd.json` schema under `schemas/` / `schemas/compiler_ir/e1/` / `schemas/compiler_trace_index/e1/` / `schemas/hello/e1/` / `schemas/index/e1/` / `schemas/index_cli/e1/` / `schemas/index_http/e1/` / `schemas/journal/e1/` / `schemas/lifecycle/e1/` / `schemas/llm/openai_compatible/e1/` / `schemas/native/e1/` / `schemas/scrape/e1/` / `schemas/scrape/e2/` / `schemas/scrape/e3/`. Editing
...
pub mod deploy_checkpoints;
pub mod deploy_intent;
pub mod deploy_inverse;
