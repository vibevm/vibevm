//! `vibe-wire` — generated Rust types for vibevm wire contracts, plus
//! the hand-written behaviour layer that lives beside them.
//!
...
//!
//! The crate stopped being generation-only when the consumers began
//! re-exporting these types instead of duplicating them: a type this
//! crate defines can carry its behaviour (vocabulary strings,
//! emptiness, constructors, `finalise` passes) ONLY here — the orphan
//! rule bars every other home. That layer is [`behaviour`],
//! hand-written like any other module and regenerated by no one; the
//! generated tree owns the shapes, this layer owns what a shape
...
/// Hand-written behaviour beside the generated form: vocabulary
/// strings and their laws, emptiness and zero values, schema
/// constants, fixture builders, `finalise` passes. See the module
/// docs for why this layer lives in this crate and nowhere else.
pub mod behaviour;
