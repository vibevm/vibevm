...
pub mod explain;
pub use explain::ExplainMcpTool;
pub mod query;
...
pub mod lifecycle_run;
pub use lifecycle_run::LifecycleRunMcpTool;
pub mod requirements_query;
pub use requirements_query::RequirementsQueryMcpTool;
// ---------------------------------------------------------------------------
// shared helpers
// ---------------------------------------------------------------------------
