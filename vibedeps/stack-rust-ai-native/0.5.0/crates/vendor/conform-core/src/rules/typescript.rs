...
const TS_GUIDE_BANS: &str = "discipline://typescript-ai-native/guide#the-unsafe-set";
const TS_GUIDE_CELLS: &str = "discipline://typescript-ai-native/guide#cells";
...
///
/// ```
/// use conform_core::rules::TsUnsafeInDomain;
...
///
/// ```
/// use conform_core::rules::TsCellIsolation;
/// use conform_core::{Fact, Rule, SourceFacts};
///
...
mod tests {
    ...
    fn seam_imports_and_core_imports_pass_internals_fail() {
        ...
        assert!(conform_core_grammar_ok(&findings[0].message));
    }

    fn conform_core_grammar_ok(message: &str) -> bool {
