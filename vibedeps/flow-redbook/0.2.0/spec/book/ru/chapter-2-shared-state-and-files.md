...
Для адресуемости мы используем URI-схему — её грамматика нормативно определена один раз, в `{#uri-scheme}` протокола адресуемых спек (`spec://org.vibevm.world/addressable-specs/flows/addressable-specs/ADDRESSABLE-SPECS-PROTOCOL#uri-scheme`); здесь — цитата:
