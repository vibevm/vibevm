...
///
/// ```
/// use core_ai_native_conform::rules::SeamHasDoctest;
        ...
        for sf in facts {
            ...
            for f in &sf.facts {
                ...
                out.push(Finding {
                    ...
                    line: *line,
                    message: req_message(
                        "discipline://rust-ai-native-lang/cards/scaffold-g-doctests#ops",
...
///
/// ```
/// use core_ai_native_conform::rules::PubDoctest;
/// use core_ai_native_conform::{Fact, Rule, SourceFacts};
///
...
///
/// ```
/// use core_ai_native_conform::rules::ErrorMessageCitesReq;
/// use core_ai_native_conform::{Fact, Rule, SourceFacts};
///
...
///
/// ```
/// use core_ai_native_conform::rules::ErrorEnumCitesReq;
/// use core_ai_native_conform::{Fact, Rule, SourceFacts};
///
