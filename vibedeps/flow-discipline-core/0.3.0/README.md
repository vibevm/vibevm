# The AI-Native Code Discipline — core (flow:org.vibevm/discipline-core)
...
(`stack:org.vibevm/rust-ai-native` first: `conform-rust`, `specmap-rust`,
...
7. `spec/mechanisms/` — ENGINE-CONFORM, PROP-014 (specmap), BROWNFIELD-PROTOCOL, LEDGER-INTENT: the normative mechanism specs; `spec://discipline-core/mechanisms/…` is what code tags cite.
