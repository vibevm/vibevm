...
| | |
|---|---|
| @fact:B095-ANCHOR **anchor** | [`spec://org.vibevm.core/vibevm/common/PROP-044#machinery`](spec/common/PROP-044-change-native-formats.md#machinery) `##M-WIDE-INTEGERS-AS-STRINGS` — общее правило, отчеканенное на `repomd.size` |
...
| @fact:B095-DISPOSITION **disposition** | `open` — заведена 2026-08-20 посадками B-079; обе посадки НЕ маскируют расхождение (описания полей его записывают), но правило и прецеденты разошлись, и границу класса решает владелец |
