...
- ##B041-DRAFT **Первый черновик написан** (2026-08-02, тем же ситтингом по «да, продолжай»): [`spec/design/tooling-development-map.md`](spec/design/tooling-development-map.md) — четыре плоскости + паркованный security-оверлей, хребет зависимостей, волны А–Г (предложение), десять развилок владельца, пять наблюдаемых вех. Ждёт чтения владельца; волны и развилки — предложения до его слова.
