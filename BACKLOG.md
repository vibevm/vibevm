...
|---|---|---|---|
| @fact:OWNER-Q1 **1** @status:impl/done | формат каталога пакетов: схемы, генерация, эволюция | [`#b-073`](#b-073) | **разобран, не решён** — три круга исследования, до дизайна не дошли |
