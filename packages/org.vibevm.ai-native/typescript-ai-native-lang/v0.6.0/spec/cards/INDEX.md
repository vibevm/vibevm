...
| `scaffold-e-fast-loop` | E+H | scaffold E | gate | [E-strong] | shipped (`typescript-ai-native fast-loop`; the tsc half stays a whole-tree floor step — no per-cell project mode without references) |
| `scaffold-f-structured-diagnostics` | E+C | scaffold F | inline | [E-mid] | shipped (`ts-unsafe-in-domain` / `ts-cell-isolation` speak the Class-F grammar, typescript-ai-native-conform) |
...
| `scaffold-i-codemods` | H+A | scaffold I | raid | **[E-hyp]** | pilot prototype shipped (`typescript-ai-native codemod add-cell`); free parameterization stays the open R4 question |
