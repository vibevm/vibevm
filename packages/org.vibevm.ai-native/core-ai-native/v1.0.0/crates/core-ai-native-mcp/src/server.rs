...
/// let mut server = core_ai_native_mcp::Server::new("rust-ai-native", "1.0.0", core_ai_native_mcp::ToolSet::new());
...
///
/// let mut server = Server::new("rust-ai-native", "1.0.0", ToolSet::new());
