...
//! JSON body per frame, both directions (TCG-PROTOCOL-GO §1's inner
...
/// ```
/// let mut out = Vec::new();
/// go_ai_native_tcg_bridge::frame::write_frame(
///     &mut out,
...
/// let frame = go_ai_native_tcg_bridge::frame::read_frame(&mut reader)
///     .expect("read")
///     .expect("some");
/// assert_eq!(frame["jsonrpc"], "2.0");
/// assert!(
///     go_ai_native_tcg_bridge::frame::read_frame(&mut reader)
///         .expect("eof read")
///         .is_none()
/// );
/// ```
