//! The position cell (TCG-PROTOCOL-GO §2): outer protocol positions
...
specmark::scope!("spec://go-ai-native-lang/go/mechanisms/TCG-PROTOCOL-GO-v0.1#ops");

use specmark::spec;

/// The encoding the server granted at initialize (ORACLE-GO §2).
///
/// ```
/// use go_ai_native_tcg_bridge::position::PositionEncoding;
...
///
/// ```
/// use go_ai_native_tcg_bridge::position::{OuterPosition, PositionEncoding, to_lsp};
...
///
/// ```
/// use go_ai_native_tcg_bridge::position::{PositionEncoding, from_lsp};
