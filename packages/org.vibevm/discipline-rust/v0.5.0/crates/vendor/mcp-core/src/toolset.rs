...
specmark::scope!("spec://discipline-core/mechanisms/MCP-CORE-v0.1#toolset");
...
///
/// ```
/// let out = mcp_core::ToolOutput::ok("floor: all green");
/// assert!(!out.is_error);
/// let red = mcp_core::ToolOutput::failed("conform: 3 new finding(s)");
/// assert!(red.is_error);
/// ```
#[derive(Debug, Clone)]
...
///
/// ```
/// use mcp_core::{Tool, ToolDescriptor, ToolOutput, ToolSet};
/// use serde_json::Value;
///
/// struct Ping;
/// impl Tool for Ping {
