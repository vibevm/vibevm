...
specmark::scope!("spec://rust-ai-native/mechanisms/TCG-ORACLE-RUST-v0.1#root");
...
#[spec(implements = "spec://rust-ai-native/mechanisms/TCG-PROTOCOL-RUST-v0.1#errors")]
pub enum TcgBridgeError {
    #[error(
        "violates spec://rust-ai-native/mechanisms/TCG-ORACLE-RUST-v0.1#resolution: \
    ...
    #[error(
        "violates spec://rust-ai-native/mechanisms/TCG-ORACLE-RUST-v0.1#session: \
    ...
    #[error(
        "violates spec://rust-ai-native/mechanisms/TCG-ORACLE-RUST-v0.1#lifecycle: \
    ...
    #[error(
        "violates spec://rust-ai-native/mechanisms/TCG-PROTOCOL-RUST-v0.1#parity: \
    ...
    #[error(
        "violates spec://rust-ai-native/mechanisms/TCG-PROTOCOL-RUST-v0.1#errors: \
...
/// ```
#[spec(implements = "spec://rust-ai-native/mechanisms/TCG-ORACLE-RUST-v0.1#config")]
...
/// winner).
#[spec(implements = "spec://rust-ai-native/mechanisms/TCG-ORACLE-RUST-v0.1#resolution")]
...
mod tests {
    ...
    fn every_variant_carries_kind_and_recipe() {
        ...
        for (e, kind, hint) in cases {
            ...
            let msg = e.to_string();
            assert!(msg.contains("spec://rust-ai-native/mechanisms/"), "{msg}");
