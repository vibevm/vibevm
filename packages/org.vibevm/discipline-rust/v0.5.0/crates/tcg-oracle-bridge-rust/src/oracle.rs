...
specmark::scope!("spec://rust-ai-native/mechanisms/TCG-ORACLE-RUST-v0.1#overlays");
...
#[spec(implements = "spec://rust-ai-native/mechanisms/TCG-ORACLE-RUST-v0.1#overlays")]
