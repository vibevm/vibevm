...
/// ```
/// let mut out = Vec::new();
/// tcg_oracle_bridge_rust::frame::write_frame(
///     &mut out,
...
/// let frame = tcg_oracle_bridge_rust::frame::read_frame(&mut reader)
///     .expect("read")
///     .expect("some");
/// assert_eq!(frame["jsonrpc"], "2.0");
/// assert!(
///     tcg_oracle_bridge_rust::frame::read_frame(&mut reader)
///         .expect("eof read")
///         .is_none()
/// );
/// ```
