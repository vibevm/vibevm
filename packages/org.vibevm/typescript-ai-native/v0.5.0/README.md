# AI-Native TypeScript (stack:org.vibevm/typescript-ai-native)
...
- `stack:org.vibevm/typescript-ai-native-lang` — the language stack: the
  TypeScript GUIDE, the cards, and the runnable toolchain
  (`discipline-typescript`, `conform-typescript`, `specmap-typescript`,
  `tcg-typescript`).
- `mcp:org.vibevm/typescript-ai-native-mcp` — the same toolchain served over
...
Require `stack:org.vibevm/typescript-ai-native` (`^0.5`) to get the whole
