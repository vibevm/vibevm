...
specmark::scope!("spec://discipline-core/mechanisms/MCP-CORE-v0.1#server");
...
///
/// ```no_run
/// let mut t = mcp_core::StdioTransport::new();
/// let mut server = mcp_core::Server::new("discipline-rust", "0.6.0", mcp_core::ToolSet::new());
...
///
/// ```
/// use mcp_core::{Server, ToolSet};
///
/// let mut server = Server::new("discipline-rust", "0.6.0", ToolSet::new());
/// let mut script = mcp_core::testing::Scripted::new(vec![
