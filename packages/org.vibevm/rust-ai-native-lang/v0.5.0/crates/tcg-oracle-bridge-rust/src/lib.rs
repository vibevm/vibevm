...
specmark::scope!("spec://rust-ai-native-lang/mechanisms/TCG-ORACLE-RUST-v0.1#root");
...
///
/// ```
/// use tcg_oracle_bridge_rust::TcgBridgeError;
...
#[spec(implements = "spec://rust-ai-native-lang/mechanisms/TCG-PROTOCOL-RUST-v0.1#errors")]
pub enum TcgBridgeError {
    #[error(
        "violates spec://rust-ai-native-lang/mechanisms/TCG-ORACLE-RUST-v0.1#resolution: \
    ...
    #[error(
        "violates spec://rust-ai-native-lang/mechanisms/TCG-ORACLE-RUST-v0.1#session: \
    ...
    #[error(
        "violates spec://rust-ai-native-lang/mechanisms/TCG-ORACLE-RUST-v0.1#lifecycle: \
    ...
    #[error(
        "violates spec://rust-ai-native-lang/mechanisms/TCG-PROTOCOL-RUST-v0.1#parity: \
    ...
    #[error(
        "violates spec://rust-ai-native-lang/mechanisms/TCG-PROTOCOL-RUST-v0.1#errors: \
...
///
/// ```
/// let c = tcg_oracle_bridge_rust::ra_config();
/// assert_eq!(c["diagnostics"]["experimental"]["enable"], true);
/// ```
#[spec(implements = "spec://rust-ai-native-lang/mechanisms/TCG-ORACLE-RUST-v0.1#config")]
...
/// ```
/// use std::path::Path;
/// use tcg_oracle_bridge_rust::verbatim_free;
/// assert_eq!(
...
/// winner).
#[spec(implements = "spec://rust-ai-native-lang/mechanisms/TCG-ORACLE-RUST-v0.1#resolution")]
...
mod tests {
    ...
    fn every_variant_carries_kind_and_recipe() {
        ...
        for (e, kind, hint) in cases {
            ...
            let msg = e.to_string();
            assert!(
                msg.contains("spec://rust-ai-native-lang/mechanisms/"),
                "{msg}"
            );
