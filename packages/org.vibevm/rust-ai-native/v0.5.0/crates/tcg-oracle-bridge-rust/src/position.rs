...
specmark::scope!("spec://rust-ai-native/mechanisms/TCG-PROTOCOL-RUST-v0.1#ops");
...
///
/// ```
/// use tcg_oracle_bridge_rust::position::PositionEncoding;
...
///
/// ```
/// use tcg_oracle_bridge_rust::position::{
