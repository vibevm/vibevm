...
/// `vibe install` + `discipline-rust init` leaves behind.
...
"#,
    ...
    write(
        root,
        "vibedeps/flow-discipline-core/0.3.0/vibe.toml",
        "[package]\nname = \"discipline-core\"\ngroup = \"org.vibevm\"\nkind = \"flow\"\nversion = \"0.3.0\"\n",
    );
    write(
        root,
        "vibedeps/flow-discipline-core/0.3.0/spec/mechanisms/ENGINE-X-v0.1.md",
        "## Rules {#rules}\n`req r1`\n\nbody\n",
    );
    tmp
}
...
fn init_then_trace_resolves_and_the_gates_catch_violations() {
    ...
    assert!(
        specmap_policy.contains("root = \"vibedeps/flow-discipline-core/0.3.0/spec\""),
        "{specmap_policy}"
    );
    ...
    write(
        ...
        "specmark::scope!(\"spec://discipline-core/mechanisms/ENGINE-X-v0.1#rules\");\n",
    );
