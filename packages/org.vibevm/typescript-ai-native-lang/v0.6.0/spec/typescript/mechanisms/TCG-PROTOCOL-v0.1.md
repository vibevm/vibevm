...
taxonomy. One shape serves both hops — vibe-mcp ⇄ `typescript-ai-native-tcg
...
`typescript-ai-native-tcg serve` speaks §1–§2 upward unchanged and widens two
...
mirrored as typed variants in `typescript-ai-native-tcg-bridge`):
