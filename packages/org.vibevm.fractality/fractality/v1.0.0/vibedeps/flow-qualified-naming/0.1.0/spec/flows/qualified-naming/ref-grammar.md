...
| **group-qualified** | `org.vibevm/wal` | **anywhere** — CLI, manifests, lockfiles |
| **kind + group-qualified** | `flow:org.vibevm/wal` | anywhere — the fully explicit form |
| **versioned** | `org.vibevm/wal@0.6.0` | anywhere a specific release is meant |
