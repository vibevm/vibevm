...
| @fact:ROW-AXIS-C **C. Qualified naming** @status:doc/done | Reverse-FQDN at the top (`org.vibevm.wal`), short aliases (`wal`) kept @status:doc/done | Maven `groupId:artifactId` @status:doc/done |
