...
- **A rename can break rustfmt** — `spec://rust-ai-native/…` →
  `spec://rust-ai-native-lang/…` grew one assert line in
...
`packages/org.vibevm/rust-ai-native/v0.2.0/crates/` (100%/89%/88% renames) +
...
`packages/org.vibevm/rust-ai-native/v0.2.0/crates/` (100% renames, history
...
- **Packaging:** `stack:org.vibevm/typescript-ai-native@0.2.0` mirrors the Rust
