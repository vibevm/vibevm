...
specifications into `stack:org.vibevm.ai-native/rust-ai-native`. Production-grade
...
Package side (`stack:org.vibevm.ai-native/rust-ai-native`, v0.4.0):
...
- Version-bearing paths that must bump with 0.4.0→0.5.0: vibevm
  `vibe.toml` `"stack:org.vibevm.ai-native/rust-ai-native" = "^0.4.0"` (caret
  on 0.x does NOT admit 0.5), `sync-engines.toml` target
  `packages/org.vibevm.ai-native/rust-ai-native/v0.4.0/crates/vendor`, the boot
...
└─ packages/org.vibevm.ai-native/rust-ai-native/v0.5.0/          (bumped from v0.4.0)
...
Installing `stack:org.vibevm.ai-native/rust-ai-native` OBLIGES the machine to
...
`git mv packages/org.vibevm.ai-native/rust-ai-native/{v0.4.0,v0.5.0}`; manifest
