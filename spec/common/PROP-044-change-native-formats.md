...
<status stage="spec" state="done" comment="commissioned by the owner 2026-08-09 (mandate quoted in §1); synthesised from the schema-evolution discovery corpus, tree measurements, and a separately convened Fable verdict; RATIFIED by the owner 2026-08-13 («Ратификацию на сам PROP-044 даю») — the standing format ideology; the first build ran under the change-native campaign plan (executed whole and folded 2026-08-18) and the wave-2 TZ"/>
