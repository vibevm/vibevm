...
- @fact:THE-RETIREMENT-VERB-NEEDS-A-NAME **The one thing left open is the verb's name**, and it is left open deliberately: `yank` has an ecosystem precedent to borrow, retirement does not — the neighbouring systems call adjacent things "deprecate", "retract" and "relocate", and none of the three means quite this. Naming it is the owner's, since the name is what every future operator will reach for under pressure. @status:spec/plan
