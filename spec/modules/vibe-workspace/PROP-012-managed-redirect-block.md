...
- **`vibe-check`** — `CheckId::RedirectBlock` reports a malformed `<vibevm>` block (a file with anything other than zero markers or one ordered pair), composing with the boot-directory check.
