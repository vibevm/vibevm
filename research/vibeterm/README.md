...
agent can drive and observe a running vibeterm. Without the flag, none of this
is constructed (`@xterm/headless` is not even loaded) and vibeterm is a plain
terminal.
...
exiting child closes vibeterm as before.
