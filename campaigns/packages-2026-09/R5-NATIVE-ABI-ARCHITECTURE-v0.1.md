...
**R5.3-WIRING and parent ratification (central, 2026-08-31).** Full review,
correction, mutation and gate evidence is recorded in
[`R5-NATIVE-ABI-RATIFICATION.md`](R5-NATIVE-ABI-RATIFICATION.md). ARTIFACT,
WIRING and GATE are accepted; parent R5.3 is complete.

## 9. R5.4/R5.5 continuation — amended serial boundary

The evidence-driven wire → invoke → convergence → parity route is frozen in
[`R5-COMPILER-NATIVE-CONTINUATION-v0.1.md`](R5-COMPILER-NATIVE-CONTINUATION-v0.1.md).
That record is the implementation authority for R5.5-WIRE-PROJECTION through
R5.5-PARITY; the accepted R5.1–R5.3 boundaries above remain unchanged.
