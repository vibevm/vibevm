...
- **Go index** lists `rule-position-is-a-resource` (`INDEX.md:38`) and
  ...
  (`rule-declared-test-matrices.xml:5,23`). The enforcement is equal; the index
  entry is missing.
