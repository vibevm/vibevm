...
**Perimeter read.** Design: `vibevm/vibespecs/design/multiple-sources-and-plugins.xml` (66 lines),
`vibevm/vibespecs/modules/vibe-workspace/PROP-035-spec-compiler.xml` §7.3 (lines 145–172).
...
- **impl** — `vibevm/vibespecs/modules/vibe-workspace/PROP-035-spec-compiler.xml:164` — `##sequence-lead **Several sources, and the plugin form** *(B-056, owner-ruled 2026-08-04, built 2026-08-05)*:`. This is a spec-prose heading; there is no code site in `crates/vibe-spec/src/**` that "implements" a heading string.
- **test** — НЕТ
