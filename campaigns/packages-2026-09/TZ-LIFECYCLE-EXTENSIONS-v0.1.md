...
_STATUS: НЕ НАЧАТО — план записан 2026-08-25; спека-закон: `vibevm/vibespecs/common/PROP-054-lifecycle-and-extensions.xml` (при расхождении спека главнее этого файла; о расхождении — доложить, не чинить молча)._
