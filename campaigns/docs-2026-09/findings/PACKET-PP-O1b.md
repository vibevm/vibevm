...
> **Отложен.** По слову владельца 2026-09-12 дорогие прогоны сведены к
> необходимому: семь исправленных промптов перепрогоняются гарнитурой A2.29
> фазы 2, которая делает это механически; пакет сохранён как список первых
> прогонов для неё.
