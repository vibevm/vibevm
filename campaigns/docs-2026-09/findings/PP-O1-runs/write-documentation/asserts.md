...
```
cwd: <scratch>/PP-O1/write-documentation/work
===== ASSERT: grep -q "kind = \"doc\"" vibevm/vibepacks/org.acme/notes-flow-docs/v0.1.0/vibe.toml
grep: vibevm/vibepacks/org.acme/notes-flow-docs/v0.1.0/vibe.toml: No such file or directory
----- exit: 2
