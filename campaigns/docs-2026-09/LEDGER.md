...
| A2.14, A2.24, A2.15, A2.23 | `findings/PACKET-P2-O7.md` | в работе | манифест страниц, `llms`, мета-блок, проверка переводов |
...
| A2.3, A2.5, A2.6, A2.7 | `findings/PACKET-P2-O3.md` | `cb041f5d` `feat(index): index doc packages with their relations and cards`; `9993148f` `feat(check): gate doc packages, translations and media on their contract`; `09afc33a` `feat(init): scaffold doc packages and their translations`; `93b0d7ff` `feat(cache): warm a doc package's subjects and source so citations resolve offline`; `153e68d9` `chore(cli): let the pivot read documentation and observe the manual` | J-077; отчёт воркера — по прибытии |
